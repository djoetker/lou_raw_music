...
export default function MusicPlayer() {
  ...
  return (
    <section className='flex flex-col sm:w-1/2 w-full h-full justify-center items-center mb-[1rem]'>
      ...
      <div className="flex flex-col gap-[0.5rem] p-[0.25rem] h-fit	overflow-x-scroll	min-w-[300px] w-fit bg-[#f5f5f5] bg-opacity-80 rounded-md p-[1rem] border border-solid border-black">
        <section className='flex flex-col justify-center items-center w-full h-fit'>
          <section className='flex flex-col border border-solid p-2 overflow-x-scroll min-h-[200px] max-h-[200px] bg-[#f5f5f5] bg-opacity-80 w-full border-black border border-solid rounded-md'>
